    ...
    <div class="container">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="top">
          ...
          <p><?php if (!empty($sub_product['sp_description'])) {
        ...
        <table class="table table-sm table-bordered">
          ...
          <tbody>
            ...
            ?>
              <tr>
                <td class="bg-primary" colspan="2"><?php echo $row["att_name"]; ?></td>
              </tr>
              ...
              ?>
                <tr>
                  <td> <input type="radio" class="att_radio" name="attribute_<?php echo $i; ?>" id="attribute_<?php echo $i; ?>" <?php if ($chk == 0) {
                                                                                                                                    echo "checked";
                                                                                                                                  } ?> value="<?php echo $v["val_id"]; ?>" onClick="getCombination()"></td>
            ...
            ?>
            <p style="visibility: hidden;" id="length"><?php echo $i; ?></p>
          </tbody>
          <tfoot>
            <tr>
              <th colspan="2">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <h1>Most popular quantities below... Enter custom quantity above to order any amount in between</h1>
      </div>
    </div>
