					...
					<ul>
						...
						?>
									<li class="slide1" data-transition="random">
										...
										<div class="tp-caption lfr" data-x="<?php echo $s['banner_data-x-1']; ?>" data-hoffset="<?php echo $s['banner_data-hoffset']; ?>" data-y="170" data-start="800" data-speed="2000" data-endspeed="300"><span class="style1">
												<span class="textcolor"><?php echo $s['banner_title']; ?></span> <?php echo $s['banner_title_gray']; ?></span>
										</div>
										<div class="tp-caption lfb" data-x="<?php echo $s['banner_data-x-1']; ?>" data-hoffset="-15" data-y="225" data-start="800" data-speed="2000" data-endspeed="300">
											<span class="style2">
												<?php echo $s['banner_description']; ?>
											</span>
										</div>
										<div class="tp-caption lfr" data-x="<?php echo $s['banner_data-x-1']; ?>" data-hoffset="-315" data-y="375" data-start="1300" data-speed="2000" data-easing="easeInOutQuint" data-endspeed="300">
											<a class="btn-sn" href="<?php echo $s['banner_link']; ?>">buy now</a>
										</div>
									</li>
						<?php
								}
						...
						<!-- <li class="slide1" data-transition="random">
							<img src="assets/images/slider/home/bg_slider_1.jpg"/>
							<div class="tp-caption lfr" data-x="right" data-hoffset="-56" data-y="170" data-start="800" data-speed="2000" data-endspeed="300"><span class="style1">
								<span class="textcolor">Flyers</span> & Leaflets</span>
							</div> 
							...
							<div class="tp-caption lfr" data-x="right" data-hoffset="-315" data-y="375" data-start="1300" data-speed="2000" data-easing="easeInOutQuint" data-endspeed="300">
							<a class="btn-sn" href="#">buy now</a></div> 
						</li>

						<li class="slide2" data-transition="random">
							<img src="assets/images/slider/home/bg_slider_2.jpg"/>
							<div class="tp-caption lfr" data-x="left"  data-hoffset="" data-y="170" data-start="800" data-speed="2000" data-endspeed="300">
								<span class="style1"><span class="textcolor">Flyers</span> & Leaflets</span>
						  </div> 
						...
						<li class="slide3" data-transition="random" ><img src="assets/images/slider/home/bg_slider_3.jpg" alt="" />
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 block block-left">
						<a href="#" class="image">
							<img src="<?php echo base_url(); ?>assets/images/banner/category/1.jpg" alt="banner-category" />
						</a>
						<div class="info">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 block block-center">
						<div class="inner-top">
							<div class="box-left">
								<a href="#" class="image frist">
									<img src="<?php echo base_url(); ?>assets/images/banner/category/2.jpg" alt="banner-category" />
								</a>
								<div class="info">
									<a href="#">BROCHURE</a>
								</div>
							...
							<div class="box-right">
								<a href="#" class="image">
									<img src="<?php echo base_url(); ?>assets/images/banner/category/3.jpg" alt="banner-category" />
								</a>
								<div class="info">
						...
						<div class="inner-bottom">
							<a href="#" class="image">
								<img src="<?php echo base_url(); ?>assets/images/banner/category/4.jpg" alt="banner-category" />
							</a>
							<div class="info">
								<a href="#">LOGO PRINT</a>
							</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 block block-right">
						<div class="inner-top">
							<a href="#" class="image">
								<img src="<?php echo base_url(); ?>assets/images/banner/category/5.jpg" alt="banner-category" />
							</a>
							<div class="info">
								<a href="#">ENVELOPE</a>
							</div>
						...
						<div class="inner-bottom">
							<a href="#" class="image">
								<img src="<?php echo base_url(); ?>assets/images/banner/category/6.jpg" alt="banner-category" />
							</a>
							<div class="info">
						...
						?>
									...
									<li class="pro-item">
										<div class="product-image-action">
											<img src="<?php echo base_url(); ?>assets/images/products/<?php echo $d['p_id']; ?>/<?php echo $d['p_image']; ?>" />
											<span class="product-icon sale-icon">sale!</span>
										</div>
										<div class="product-info">
											<a href="#" title="product" class="product-name"><?php echo $d['p_name']; ?></a>
											<div class="price-box">
												<span class="normal-price">From $ 9.00</span>
											</div>
		...
		<section class="home-new-product home-product parten-bg">
			<div class="container">
				<div class="row">
					...
					<div class="block-title-w">
						<h2 class="block-title">New print Templates</h2>
						<span class="icon-title">
							<span></span>
							<i class="fa fa-star"></i>
						</span>
					...
					<!--New Products Title : End -->
					<div class="tab-content">
						<div class="tab-pane active" id="tab1">
							<!--New Products Large Item : Begin -->
							<div class="col-md-6 col-sm-8 hidden-xs">
								<div class="pro-item large-item">
									<div class="product-image-action">
										<img src="<?php echo base_url(); ?>assets/images/product/business-card-large-item.jpg" alt="Grouper Business card">
										<div class="action">
										...
										<span class="product-icon hot-icon">Hot</span>
									</div>
									<div class="product-info">
										<a href="#" title="product" class="product-name">Grouper Business card</a>
										<div class="price-box">
											<span class="normal-price">$ 9.00</span>
										</div>
										<a class="view-more" href="#" title="view more product">
											View more
										</a>
									</div>
								</div>
							</div>
							<!--New Products Large Item : End -->
							<!--New Products Item Col1 : Begin -->
							<div class="col-md-3 col-sm-4">
								<div class="pro-item visible-xs">
									<div class="product-image-action">
										<img src="<?php echo base_url(); ?>assets/images/product/263x263/business-card-2.jpg" alt="Business card 2">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i>
											</button>
									...
									<div class="product-info">
										<a href="#" title="product" class="product-name">Business card 2</a>
										<div class="price-box">
											<span class="normal-price">$ 16.98</span>
										</div>
										<div class="rating-box">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
								...
								<div class="pro-item">
									<div class="product-image-action">
										<img src="<?php echo base_url(); ?>assets/images/product/263x263/eSliproser-postcard.jpg" alt="eSliproser Postcards">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i>
											</button>
									...
									<div class="product-info">
										<a href="#" title="product" class="product-name">eSliproser Postcards</a>
										<div class="price-box">
											<span class="normal-price">$ 16.98</span>
										</div>
										<div class="rating-box">
								...
								<div class="pro-item">
									<div class="product-image-action">
										<img src="<?php echo base_url(); ?>assets/images/product/263x263/new-business-card.jpg" alt="New Business card">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i>
											</button>
									...
									<div class="product-info">
										<a href="#" title="product" class="product-name">New Business card</a>
										<div class="price-box">
							...
							<!--New Products Item Col1 : End -->
							<!--New Products Item Col2 : Begin -->
							<div class="col-md-3 visible-md visible-lg">
								<div class="pro-item">
									<div class="product-image-action">
										<img src="<?php echo base_url(); ?>assets/images/product/263x263/new-postcard-card.jpg" alt="New Postcard Cards">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i>
											</button>
									...
									<div class="product-info">
										<a href="#" title="product" class="product-name">New Postcard Cards</a>
										<div class="price-box">
								...
								<div class="pro-item">
									<div class="product-image-action">
										<img src="<?php echo base_url(); ?>assets/images/product/263x263/postcard-mailing-services.jpg" alt="Postcard Mailing Services">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i>
											</button>
									...
									<div class="product-info">
										<a href="#" title="product" class="product-name">Postcard Mailing Services</a>
										<div class="price-box">
											<span class="normal-price">$ 9.00</span>
										</div>
										<div class="rating-box">
						...
						<div class="tab-pane" id="tab2">
							...
							<div class="col-md-6 col-sm-8 hidden-xs">
								<div class="pro-item large-item">
									...
									<div class="product-info">
										...
										<a class="view-more" href="#" title="view more product">View more</a>
									</div>
								</div>
							</div>
							<!--New Products Large Item : End -->
							...
							<div class="col-md-3 visible-md visible-lg">
								<div class="pro-item">
									<div class="product-image-action">
										<img src="<?php echo base_url(); ?>assets/images/product/263x263/grouper-business-card.jpg" alt="New Postcard Cards">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i>
											</button>
								...
								<div class="pro-item">
									<div class="product-image-action">
										<img src="<?php echo base_url(); ?>assets/images/product/263x263/flyers-two-page.jpg" alt="Postcard Mailing Services">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i>
											</button>
							...
							<div class="slider-inner">
								<div class="wrap-item">
									<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 item">
										<div class="inner">
											<a class="image" href="#">
												<img src="<?php echo base_url(); ?>assets/images/blog/1.jpg" alt="blog-01" />
											</a>
											<div class="info">
												<div class="title">
									...
									<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 item item-even">
										<div class="inner">
											...
											<a class="image" href="#">
												<img src="<?php echo base_url(); ?>assets/images/blog/2.jpg" alt="blog-01" />
											</a>
										</div>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 item">
										<div class="inner">
											<a class="image" href="#">
												<img src="<?php echo base_url(); ?>assets/images/blog/3.jpg" alt="blog-01" />
											</a>
											<div class="info">
												<div class="title">
													<a href="#">Happy Holidays Photo Cards</a>
									...
									<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 item item-even">
										<div class="inner">
											...
											<a class="image" href="#">
												<img src="<?php echo base_url(); ?>assets/images/blog/4.jpg" alt="blog-01" />
											</a>
										</div>
									</div>
								</div>
				...
				<div class="row">
					...
					<div class="or-service-w">
						<div class="col-md-3 col-sm-6 col-xs-6 or-block">
							<div class="or-image">
								<a href="#">
									<img src="<?php echo base_url(); ?>assets/images/our_service/1.png" alt="service-01" />
								</a>
							</div>
							<div class="or-title">
						...
						<div class="col-md-3 col-sm-6 col-xs-6 or-block">
							<div class="or-image">
								<a href="#">
									<img src="<?php echo base_url(); ?>assets/images/our_service/2.png" alt="service-02" />
								</a>
							</div>
							<div class="or-title">
								<a href="#">Mailing</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 or-block">
							<div class="or-image">
								<a href="#">
									<img src="<?php echo base_url(); ?>assets/images/our_service/3.png" alt="service-03" />
								</a>
							</div>
							<div class="or-title">
						...
						<div class="col-md-3 col-sm-6 col-xs-6 or-block">
							<div class="or-image">
								<a href="#">
									<img src="<?php echo base_url(); ?>assets/images/our_service/4.png" alt="service-04" />
								</a>
							</div>
							<div class="or-title">
						...
						<div class="tab-pane active" id="tab11">
							<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
								<div class="w-block-recent">
									<div class="image-recent">
										<a href="#">
											<img src="<?php echo base_url(); ?>assets/images/our_service/5.png" alt="service-05" />
										</a>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
								<div class="w-block-recent">
									<div class="image-recent">
										<a href="#">
											<img src="<?php echo base_url(); ?>assets/images/our_service/6.png" alt="service-06" />
										</a>
									</div>
									<div class="info-recent">
										<h2 class="title">eSliproser Postcards</h2>
							...
							<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
								<div class="w-block-recent">
									<div class="image-recent">
										<a href="#">
											<img src="<?php echo base_url(); ?>assets/images/our_service/7.png" alt="service-07" />
										</a>
									</div>
									<div class="info-recent">
										<h2 class="title">eSliproser Postcards</h2>
							...
							<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
								<div class="w-block-recent">
									<div class="image-recent">
										<a href="#">
											<img src="<?php echo base_url(); ?>assets/images/our_service/8.png" alt="service-08" />
										</a>
									</div>
									<div class="info-recent">
										<h2 class="title">eSliproser Postcards</h2>
							...
							<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
								<div class="w-block-recent">
									<div class="image-recent">
										<a href="#">
											<img src="<?php echo base_url(); ?>assets/images/our_service/9.png" alt="service-09" />
										</a>
									</div>
									<div class="info-recent">
										<h2 class="title">eSliproser Postcards</h2>
							...
							<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
								<div class="w-block-recent">
									<div class="image-recent">
										<a href="#">
											<img src="<?php echo base_url(); ?>assets/images/our_service/10.png" alt="service-10" />
										</a>
									</div>
									<div class="info-recent">
										<h2 class="title">eSliproser Postcards</h2>
						...
						<div class="slider-inner">
							<div class="wrap-item">
								<div class="item">
									<div class="inner">
										<div class="image">
											<a href="#"><img src="<?php echo base_url(); ?>assets/images/testimonials/1.png" alt="terminal-01" /></a>
										</div>
										<div class="tes-name">
								...
								<div class="item">
									<div class="inner">
										<div class="image">
											<a href="#"><img src="<?php echo base_url(); ?>assets/images/testimonials/2.png" alt="terminal-01" /></a>
										</div>
										<div class="tes-name">
											<a href="#">Sam Ibister</a>
										</div>
								...
								<div class="item">
									<div class="inner">
										<div class="image">
											<a href="#"><img src="<?php echo base_url(); ?>assets/images/testimonials/3.png" alt="terminal-01" /></a>
										</div>
										<div class="tes-name">
											<a href="#">Sam Ibister</a>
										</div>
				...
				<div class="row">
					<div class="bran-block">
						<div class="item col-md-2 col-sm-4 col-xs-6">
							<a href="#" class="image">
								<img src="<?php echo base_url(); ?>assets/images/brands/1.png" alt="brand-01" />
							</a>
						</div>
						<div class="item col-md-2 col-sm-4 col-xs-6">
							<a href="#" class="image">
								<img src="<?php echo base_url(); ?>assets/images/brands/2.png" alt="brand-02" />
							</a>
						</div>
						<div class="item col-md-2 col-sm-4 col-xs-6">
							<a href="#" class="image">
								<img src="<?php echo base_url(); ?>assets/images/brands/3.png" alt="brand-03" />
							</a>
						</div>
						<div class="item col-md-2 col-sm-4 col-xs-6">
							<a href="#" class="image">
								<img src="<?php echo base_url(); ?>assets/images/brands/4.png" alt="brand-04" />
							</a>
						</div>
						<div class="item col-md-2 col-sm-4 col-xs-6">
							<a href="#" class="image">
								<img src="<?php echo base_url(); ?>assets/images/brands/5.png" alt="brand-05" />
							</a>
						</div>
						<div class="item col-md-2 col-sm-4 col-xs-6">
							<a href="#" class="image">
								<img src="<?php echo base_url(); ?>assets/images/brands/6.png" alt="brand-06" />
							</a>
						</div>
					</div>
				</div>
