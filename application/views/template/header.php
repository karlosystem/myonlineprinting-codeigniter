...
<head>
	...
	<link rel="stylesheet" href="http://www.copyserviceusa.com/assets/frontend/css/jquery.countdown.css">
					...
					<div class="top-header-right f-right col-lg-5 col-md-6 col-sm-7 col-xs-6">
						<div class="w-header-right">
							...
							<div class="th-hotline">
								...
								<span>
									<a href="https://www.myonlineprinting.net/admin" target="_new" style="position: relative; color: white;">admin</a>
								</span> |
								<span>
									<a href="https://myonlineprinting.net/intranet/public/" target="_new" style="position: relative; color: white;">Sistema de Ventas</a>
								</span>
							</div>
						</div>
					</div>
