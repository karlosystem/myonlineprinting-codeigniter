...
?>
			...
			<form action="<?php echo base_url(); ?>admin/values/update_value" id="add_attribute_form" name="add_attribute_form" class="contact-form" method="POST" >
				...
				<ol>
					...
					<li>
							...
							foreach($attribute_array as $a)  {?>
								<option value="<?php  echo $a['att_id'] ?>" <?php  if($a['att_id'] ==$value['att_id']) {   echo "selected='selected'"; } ?>><?php echo $a['att_name']; ?></option>
					...
					<li>
							...
							<input type="text"  name="value_name" id="value_name" class="input-xlarge text" value="<?php   if(!empty($value['value_name']))  {  echo  $value['value_name']; }?>">
					</li>
					<li>
