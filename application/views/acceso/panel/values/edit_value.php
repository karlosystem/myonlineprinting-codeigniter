...
<main>
  <div class="container-fluid px-4">
    ...
    <div class="col-md-3">
      <div class="card mb-4">
        <div class="card-body">
          <form action="<?php echo base_url(); ?>admin/values/update_value" id="add_attribute_form" name="add_attribute_form" method="POST">
            ...
            <div class="mb-3">
              ...
              <select type="text" name="att_id" id="att_id" class="form-select">
                ...
                foreach ($attribute_array as $a) { ?>
                  <option value="<?php echo $a['att_id'] ?>" <?php if ($a['att_id'] == $value['att_id']) {
            ...
            <div class="mb-3">
              ...
              <input type="text" name="value_name" id="value_name" class="form-control" value="<?php if (!empty($value['value_name'])) {
