...
function () {
  ...
  function WhatsappButton(pNumber, wMessage, phMessage, dMessage, iconStyle, color, subColor, textColor, fontFamily) {
    ...
    this.svgWhatsappPath = this.whatsappIcon ? base_url + "node_modules/whatsapp-button/dist/wpp_icons/My icons collection-SVG-sprite.svg#".concat(this.whatsappIcon) : base_url + "node_modules/whatsapp-button/dist/wpp_icons/My icons collection-SVG-sprite.svg#whatsapp";
  ...
  _createClass(WhatsappButton, [{
    ...
    value: function initButtonElements(background, fontFamily) {
      ...
      this.svgButton = this.newElem("svg", "class", "iconchat"); //aqui
      ...
      this.svgLabelUse = this.newElem("use", ["xlink:href", "class"], [base_url + "node_modules/whatsapp-button/dist/wpp_icons/My icons collection-SVG-sprite.svg#send-button", "svgLabelUse"]);
    }
  }, {
